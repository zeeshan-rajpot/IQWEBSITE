      ...
      <>
        <div className="hidden md:flex items-center justify-center md:w-4/6 mx-auto space-x-3 mt-2">
          {steps.map((step, index) => (
            <div
              key={index}
              className={`cursor-pointer rounded-full w-20 h-2 flex items-center justify-center ${index === activeStep
                  ? "bg-blue-500 text-white"
                  : "bg-gray-300 text-gray-600"
                }`}
            >
            ...
            <div className="text-center w-11/12 md:5/6 lg:5/6 2xl:w-6/6 mx-auto">
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 gap-3 place-items-center md:w-10/12 m-auto my-12">
                {steps[activeStep].options.map((option, index) => (
                  <div
                    key={index}
                    className={`relative w-10/12 md:w-12/12 ${formData[`step${activeStep + 1}`] === option
              ...
              <div className="my-4">
                {activeStep < steps.length - 1 && (
                  <button
                    ...
                    className={`px-[100px] py-3 border rounded-full duration-200 ${formData[`step${activeStep + 1}`]
...
>>>>>>> a03dc980f6c4e79381adef0200742bc560322472
