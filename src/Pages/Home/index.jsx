      ...
      <div className=" w-11/12 md:5/6 lg:5/6 2xl:w-4/6  pt-10   mx-auto">
        <div className="text-center">
          ...
          <p className="lg:text-xl font-normal text-ptheme ">
            ...
            candidate based on several parameters (population, age group, level
            of study, field of study). Our following statistics are derived from
            our studies of all the candidates on the global scale over several
