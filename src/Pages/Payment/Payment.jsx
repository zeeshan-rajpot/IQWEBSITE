          ...
          <div className=" w-11/12 md:5/6 lg:5/6 2xl:w-4/6  py-4   mx-auto">
            <div className="flex flex-col justify-center text-center">
              ...
              <p className="lg:text-xl font-normal text-ptheme mt-3">
                To build your results and statistics, please fill this form and
                pay 5$.
              </p>
            </div>
          </div>
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-gray-500   placeholder:text-gray-400 focus:ring-2 focus:ring-inset  sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
