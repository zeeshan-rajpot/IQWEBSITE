...
const Payment = () => {
  ...
  const spentTime = sessionStorage.getItem('spentTime');
      ...
      <div>
        ...
        {paymentCompolete && (
          <div>
            ...
            <section>
              <div className=' w-11/12 md:w-5/6 lg:w-4/6 2xl:w-4/6  py-4   mx-auto  mb-12'>
                  ...
                  <div className='sm:col-span-3'>
                    ...
                    <div className='mt-2'>
                      <input
                        ...
                        className='block w-full rounded-md border-0 px-3 py-3 text-gray-900  ring-gray-500 shadow-md  placeholder:text-gray-400 focus:ring-2 focus:ring-inset  sm:text-sm sm:leading-6'
                        value={fullname}
                  ...
                  {isOpen && (
                    ...
                    >
                      <motion.div
                        ...
                        className='bg-theme  p-6 rounded-lg w-full shadow-xl cursor-default relative overflow-hidden'
                      >
                        <>
                          <div className='text-center'>
                            <p className='lg:text-xl font-normal text-white my-6 '>
                          ...
                          <div className='w-11/12 md:w-5/6 lg:w-5/6 2xl:w-5/6 mx-auto  mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
                            <div className='col-span-6'>
                              <label className='block text-md text-white font-thin '>
                            ...
                            <div className='col-span-6 sm:col-span-3'>
                              ...
                              <div className='mt-2'>
                                <input
                                  ...
                                  id='name'
                                  autoComplete='given-name'
                                  className='block w-full rounded-md border-0 py-3 px-2 text-gray-900  ring-gray-500 shadow-md  placeholder:text-gray-400 focus:ring-2 focus:ring-inset  sm:text-sm sm:leading-6'
                                />
                              </div>
                            </div>
                            ...
                            <div className='col-span-6 sm:col-span-3'>
                              ...
                              <div className='mt-2'>
                                <input
                                  ...
                                  className='block w-full rounded-md  py-3 px-2 text-gray-900 shadow-md  ring-gray-300 placeholder:text-gray-400 border-0   sm:text-sm sm:leading-6'
                                />
                              </div>
                            </div>
                          ...
                          <div className='flex justify-center mt-12'>
                            <button
                              ...
                              className='px-[100px] bg-white text-theme  py-3 border border-white rounded-full  hover:bg-transparent hover:text-white duration-200'
                            >
                              Pay Now
                            </button>
                          </div>
